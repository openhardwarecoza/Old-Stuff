...
cprequire_test(["inline:com-chilipeppr-workspace-reprap"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-reprap", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-reprap", // Make the id the same as the cpdefine id
        name: "Workspace / Reprap 3D Printing", // The descriptive name of your widget.
        desc: `This is a workspace for 3D printing on Marlin/Smoothie/Repetier.`,
        ...
        loadWidgets: function(callback) {
            ...
            //             // we have the data
            //             // double check it's a DXF or a board file, cuz it could be gcode
