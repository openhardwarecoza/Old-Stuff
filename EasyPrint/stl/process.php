...
<?php
   // Configuration - Your Options
      ...
      $upload_path = '/srv/www/vhosts/easyprn/stl/objects/'; // The place the files will be uploaded to (currently a 'files' directory).
...
<form action="/slice/settings.php" method="post" enctype="multipart/form-data">
   <p>
