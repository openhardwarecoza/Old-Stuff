...
void ui_init_keys() {
#if UI_HAS_KEYS!=0
  UI_KEYS_INIT_CLICKENCODER_LOW(52,50); // click encoder on pins 47 and 45. Phase is connected with gnd for signals.
...
void ui_check_keys(int &action) {
 ...
 UI_KEYS_CLICKENCODER_LOW_REV(52,50); // click encoder on pins 47 and 45. Phase is connected with gnd for signals.
