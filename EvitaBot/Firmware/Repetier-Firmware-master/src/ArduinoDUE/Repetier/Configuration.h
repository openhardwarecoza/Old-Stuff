...
*/
    ...
    #define XAXIS_STEPS_PER_MM 106
    /** \brief Number of steps for a 1mm move in y direction.
    For xy gantry use 2*belt moved!
    Overridden if EEPROM activated.*/
    #define YAXIS_STEPS_PER_MM 80.0000
    /** \brief Number of steps for a 1mm move in z direction  Overridden if EEPROM activated.*/
    #define ZAXIS_STEPS_PER_MM 800.00
#endif
...
#define EXT0_STEPS_PER_MM 189 //425 // 825.698 //457 
...
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Z 80
...
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_Z 80
...
#define UI_PRINTER_NAME "EvitaBot"
#define UI_PRINTER_COMPANY "OpenHardwarecoza"
