...
#define FAN_PIN   9  // Extruder 2 uses the default fan output, so move to an other pin
...
#define XAXIS_STEPS_PER_MM 108
/** \brief Number of steps for a 1mm move in y direction.
For xy gantry use 2*belt moved!
Overridden if EEPROM activated.*/
#define YAXIS_STEPS_PER_MM 108
...
#define EXT0_STEPS_PER_MM 97 //385
